...
FIX Figure~\ref{fig-extensions-logic} illustrates five general types of extension to the base model.  In each case, we introduce the class and give several examples. 
...
\section{2 Extensions to agents} % 2
...
\section{3 Extensions to firms and institutions} % 3
...
\section{1 Extensions to space} % 1
...
\section{4 Extensions to boundary} % 4
...
\section{Categories of extensions}
