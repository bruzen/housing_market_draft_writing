...
in their homes. % ({\color{red} Should newcomers also have equity? or is it built into the savings. Clarify this.} 
...
\end{figure}%{\color{red} TODO Discuss Figures 10.1 and 10.2 in text.}
