...
These are all values passed to the program on initialization. They are not all parameters strictly speaking. Some are initial values for endogenous variables, %These are {initial values} that we calculate based on the parameters above. These initial values 
