...
%The reservationn prices  is  the seller so own bid. if the highest bid received is lower than the own bid the seller is the buyer- remains the owner. Otherwise Terh bidder takes the property and the price is set no higher than the bidder's maximum bid and
