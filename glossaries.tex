...
\newglossaryentry{warranted market price}
{
name= warranted market price,
description={$\mathcal{R}_N$ at an  urban location  $d$ units from the centre, capitalized value of the flow of services provided by the property, the \gls{warranted market rent}. 
...
description={The locational value of an urban property. A surplus generated by \gls{agglomeration effects}, eequal to the urban (wage premium) minus transportation costs, $\omega-{c} d$). This is the the amount that an equilibrium market rent for a property would be expected to exceed the market rent for a similar non-urban property.}
}
