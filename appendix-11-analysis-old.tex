...
\subsection{Impressionistic notes from early batch runs.}
...
Increasing density in the range [100, 300, 400, 600]    \begin{enumerate}
        \item increases mpl
...
\subsection{increasing 'savings\_rate'} [0.5, 0.3, 0.2]
   \begin{enumerate}
...
*e tHIS IS CLEAR BUT COULD BE HELPED BY RESTATING HOW THEY MOVE IT ONTO FINANCIAL MARKETS. JUST A QUICK SUMMARY STATEMENT OF HOW THEY ARE financialization. %EVEN JUST something like \dots They put the ownership of housing onto financial markets. just to keep us oriented in what we are talkign about.
