\chapter{Background Theory of the Firm} \label{appendix-firm-theory}

{\color{red}
THIS COULD GO IN THE METHODOLOGY CHAPTER
...
%    Y_t=& N_ty^\gamma y^\]  
\end{equation}
$\gamma$ is drawn from the agglomeration literature.% but $A$ must be calculated to.
