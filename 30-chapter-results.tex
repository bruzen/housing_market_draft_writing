...
This means that without countervailing forces, financial will take an increasing share of ownership in a housing market. 

Within the model, properties are put up for sale, financial actors purchase and increasing number because they have advantages over private buyer. Primarily these advantages are related to increased ability to access capital and are based on realistic parameter values. 
\begin{figure}
\centering
\begin{tikzpicture}
...
In this section, we use our model to explore some implications of a hypothetical link between financialization of an urban housing market urban and the urban production economy.
