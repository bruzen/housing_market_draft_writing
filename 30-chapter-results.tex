...
The results suggest that 10\%  and 5\% levels are behaving similarly, while the 1\% is below some threshold and following a different pattern.
...
% \raggedleft
% \hspace{5cm}
\includegraphics[scale=1, trim={0 1.4cm .6cm 0},clip]{fig/productivity_link_174740.pdf} 
...
\node at (1.36,1.05)[align=left, font=\fontsize{90}{0}\selectfont ]{\tiny 100\% capital gains tax};
\node at (1.23,.58)[align=left, font=\fontsize{90}{0}\selectfont]{\tiny temporary zero  tax};
\end{scope}
