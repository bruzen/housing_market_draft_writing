...
%We have built the model to allow us to investigate the effects of financialization on cities. 
work. % We've made the case that these questions matter given the process of financialization underway in cities. 
...
In this case, the capital gains tax on investors is set at 15\%. {\color{red} Re-run with  0, .2 .4 .6 instead of 1. .5 AND 0? MAYBE JUSTIFY A BIT MORE}
