...
Figure ~\ref{fig:CGpers_ownership_trajectory} shows that raising the capital gains tax on owner-occupiers\footnote{In Canada, homeowners currently do not pay capital gains taxes on their primary residence. This is a policy that has been questioned because it favours owners over renters whose investments would be subject to taxes.}  will also have a powerful effect. When the owner-occupiers' tax rate is higher than the tax rate for investors, %, shown by the solid and the dashed lines,  
