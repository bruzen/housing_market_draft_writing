...
\end{enumerate} 
In total, there are forty-two plots, some null, in this section. We discuss each experiment,  point out the most significant effects, provide some explanation of results that may seem surprising.  It is important to recognize that these results are conditioned on the selection of the parameters of the model. They will vary if different parameters are chosen. The qualitative results are not affected by small variations in parameters, however. 
...
In the second section, we repeat the six policy interventions with a 33\% reduction in the value of the production parameter $A$. There are an additional forty-two plots in this section. 

Finally, in the third section, we present the results with and without productivity impacts side-by-side. This makes the effect of the productivity linkage clearer.
