...
*** QUESTION: DOES IT MAKE SENSE TO FLIP THE ORDER OF THE CHAPTERS IN LIGHT OF THIS? 

% Maybe start with rent, because we are introducing modern urban rent theory, then flip space and growth so we introduce the city first, then agglomeration effects, then financialization?
...
MAKE SURE EQUN IS CONSISTENT WITH GROWTH CHAPTER DISCUSSION.  IT is NOT!~ D.
...
The real market includes a set of agents who engage directly like buyers, sellers, renters, investors, and developers; as well as others who shape the market indirectly, including policymakers, activists, and neighbourhood and industry groups. % and those who affect the policy contexts (such as activists, developers, etc), and labour.
