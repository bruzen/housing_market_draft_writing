...
The \gls{market rent}, $\mathcal{R}_M$, is what agents actually pay. The market rent can in principle differ from the economically warranted rent as individual investors make decisions about rents and setting rents based on their own expectations, which include a wide range of factors. To clarify the implications of the model, we assume that the market rent equals the warranted rent. We are in effect imposing a   %\gls{warranted rent} is paid as the \gls{market rent}
