...
There are three pieces to this analysis - there's the warranted price based on the underlying economic value of living in a property, the link here with urban productivity, there's the biding and negotiation process, and then there's the actual realized market price. 
...
warranted is xyz
the actual  bid price, and what people will be willing to pay, acept
...
\subsubsection{Financialized investment seeks to extract the warranted rents}
...
\subsubsection{Warranted rent is a frontier}
