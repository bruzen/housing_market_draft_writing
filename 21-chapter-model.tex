...
A worker, located at a distance $d$ from work, paying as much as $w-{c} d$ in rent would still choose to work. The radius of the commuter shed is the maximum incentivized commute, $\frac{w}{{c}}$, where ${c}$ is the the cost of transportation per unit distance.
