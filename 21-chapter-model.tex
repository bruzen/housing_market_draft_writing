...
%     \centering
%     \includegraphics[scale=0.4]{fig/stylized_model_flow.png}
...
\end{equation}
This is the equilibrium \gls{urban labour supply} curve. It is our version of the standard urban \gls{population equilibrium} condition for moderls of this class, which is a \gls{migration equilibrium} \cite{GET_migration_equilibOR_pop_equilib_condition}. %It defines the quantity of labour available.
