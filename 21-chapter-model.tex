...
In the agent model model, the \gls{urban labour supply} is an \gls{aggregate} measure that emerges from individual agent's choice to seek work, model rules, and individual firm hiring behaviour. %and the job search process. 
...
including proximity to natural features like lakes and mountains, and human-built feature like communities, and businesses. %, as well a developments and additions on the property itself. 

The market includes a set of agents who engage directly like buyers, sellers, renters, investors, and developers; as well as others who shape the market indirectly, including policymakers, activists, and neighbourhood and industry groups. % and those who affect the policy contexts (such as activists, developers, etc), and labour.
These actors work within the context of a layer of policy, institutions, and rules. Financial institutions and government, structure the access to debt financing to enable purchasing,
% and there is a a layer of policy that shapes land value. . % and rules that determine the 
city zoning rules, allow certain uses and disallows others, and tax rules shape the expected financial return on property investment.
