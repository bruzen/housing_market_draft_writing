\chapter[Amenity]{Incorporating amenity - non monetary income}\label{chapter-amenity}
...
% (set it up with a dirrect connection to ownerhsip but have left out lots of the potential mechanism to get a simple clean results.) there are others - can you affect that at all is the class questions

% In the first chapter we asked, in the second we asked what extra links do you have to add to see the effects on productivity, in this we say what about amentity which is basically an extra form of wealth.
