...
This is illustrated in Figure~\ref{ig:scale_output} for $\beta=1.25$ and $G=1$. The significant feature is the upward-bending total output curve that indicates increasing productivity per capita for the city.
