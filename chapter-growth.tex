...
To understand the subsequent growth theories based on human capital, or what is sometimes called `effective labour' it is helpful to notice that Solo's formulation is unchanged if we substitute `labour times  skill' for $\L$ in his model. both components of `labour times  skill,' or effective labour grow over time. The apparent effect of increasing labour supply could be, in fact, the combined effect of rising labour supply and increasing labour skill. Lateer studies would disentangle the two.
