...
Modern urban models are essentially an application of classical rent theory. Rent in the urban system emerges from the %essential 
...
The goal of this chapter is to describe informally the spatial model that serves as the link between rent theory and growth theory. % we will use. 
To do this, we review the theory and development of the urban models central and illustrate how they % to our analysis. These models 
