...
The height of yellow triangle in Figure~\ref{fig-alonzo-simple} represents the wage premium $\omega$ for urban labour and the amount land rent earned at the centre % of the city.  at the centre, 
...
\begin{figure}
    ...
    \caption[A three-dimensional version of the Alonzo model.]{A three-dimensional version of the Alonzo rent from Figure~\ref{fig-alonzo-simple}, representing the rents and transportation costs in the Alonzo model. The entire volume is the surplus generated by the city that appears as the urban wage premium. The darker red cone at the center is the amount that can be captured as locational rents.}
