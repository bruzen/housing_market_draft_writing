...
\begin{figure}
    ...
    \caption[A three-dimensional version of the Alonso model]{A three-dimensional version of the Alonso rent from Figure~\ref{fig-alonso-simple}, representing the rents and transportation costs in the Alonso model of a circular city. The height is the wage premium $\omega$ and the radius, or distance, is  %$d^\dagger
