...
Two lines of research, growth theory and work on urban scaling, have settled on one of the most robust ``stylized facts'' in economics: wealth scales superlinearly with density. Agglomeration drives productivity growth, but what is the effect of financialization on those relationships? 

The question is important but it is complicated on at least two levels. The linkages between urban productivity and financialization have not been established. In addition, the micro level mechanisms driving productivity gains, themselves are not well understood. In this chapter we...

As discussed in Chapter~\ref{chapter-growth}, substantial empirical research has shown that the general relationship between population and output at the urban %is well approximated by 
...
Wheere Chapter~\ref{chapter-growth} introduced the theory of growth and urban scaling, here we focus on the variations in the relationship and the details of the transmission mechanism. We focus specifically on the channels through which financialization might affect the productivity and growth of cities. We call this the \gls{transmission mechanism}.
...
\section{Links between financialization and the micro-foundations of agglomeration}
...
WHAT ARE NETWORK ACCOUNTS? Network accounts of increasing returns have drawn a good deal of attention.
...
\section{The transmission puzzle in relation to finacialization of the urban housing market}
