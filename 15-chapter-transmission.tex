...
This channel would act slowly and persist after an initial round of speculative activity as local housing is bought, and the money circulates in the economy. % and get counted in registers of local activity, encouraging further investment.
...
Increasingly effective human capital increases returns to scale in the industrial sector and at the national level. 
...
We can simulate some human capital effects simply by making a link from the home-ownership ratio to the productivity parameters  $\beta$ and $A$. A more satisfactory approach would be to introduce a training industry. %this has been done=
