...
For Duranton and Puga, sharing gains arise because a larger final-goods industry will support a larger pool of input supplier who are able to offer the gains from specialization. This is an applications of one of Adam Smith's main insights. Rosenthal and Strange \cite{rosenthalEvidenceNatureSources2004} find the effect of sharing a common base of suppliers are weak relative to other motives for agglomeration, while 
 ...
 A possible indirect mechanism through which financialization might affect productivity is that increasing costs and rising inequality induced by financialization might  limit the diversity of the labour pool, reducing the potential gains from specialization.  We do not explicitly introduce workforce diversity, but it follows that any additional mechanism that reduces the diversity of the workforce could eventually reduce  Both of these channels are incorporated in Figure~\ref{fig-impact-channels}.
