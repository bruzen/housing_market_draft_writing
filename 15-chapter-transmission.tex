...
\chapter{Implications of Financialization for Urban Productivity} \label{chapter-tramsmission}%{Distribution and Growth} \label{chapter-distribution} % \chapter{Productivity Spillovers}  % \label{chapter-productivity-spillovers}
...
\section{The transmission puzzle}
 We now discuss in some detail the impact channels through which financialization actually works. 
