...
We will refer to the core urban model developed by Alonso (1964), Muth (1969) and Mills (1967), and later formalised by Wheaton (1974) and others, as the ``Alonzo Model.''\footnote{it is also called the Alonzo model, the Alonzo-Muth model, the Alonzo-Muth-Mills model, the circular city model, and the monocentric city model.} William Alonso published \textbf{Location and Land Use} in 1964 based on his 1960 Phd thesis , 
giving him a slender priority in the literature.  Richard Muth's (1961a, 1961b) were written roughly simultaneously with and independently of Alonso's thesis, and  culminated in his classic book, Cities and Housing (1969).\footnote{See ``William Alonzo, Richard Muth, Resources for  the Future, and the founding of urban economics''\cite{mcdonaldWilliamAlonsoRichard2007} for a more detailed discussion of the development of the model.}   It is worth noting that Lowdon Wingo also had a manuscript of  ``Transportation and Urban Land''(1961) (Washington, DC: Resources for the Future) in preparation that presented a core idea and  significantly influenced Muth. Mills, E.S. (1972b), ``Urban economics''. %Glenview, Illinois: Scott Foresman.
...
We use what we choose to call an \textbf{Alonzo-Jacobs model} to explore the source and distribution surplus value. The reference to Jane Jacobs links the wage premium to the Jacobs-style  agglomeration effects we now believe generate  generate urban productivity and growth.% and the wage premium. 
