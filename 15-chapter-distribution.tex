...
Coarse-grained models must capture the stylized facts, as ours does. A great deal of empirical research supports the general relationship represented by Equation~\ref{eqn-population-output}
...
\end{figure}
 ...
 The literature has identified many possible channels that are likely to affect the overall productivity of individual cities. 
