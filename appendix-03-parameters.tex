...
Taking a simplified example, if the one year rate is $x$/year, interest payments are $xM$ for each of $T$ years. 
%If we then assume tha
...
\end{align*}
 ...
 the interest rates, the $r$'s, and all the discount rates, the $\delta$'s are compounded in this way. 

 *** DOES THIS AFFECT THE borrowing ratio $m_i$?
