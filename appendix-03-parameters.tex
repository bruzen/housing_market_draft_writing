...
\[\frac{\ref{SS:rentshare}B4.2}{B4.3\left( (1+B4.4 - (1+B4.5)B4.6\right)}\]

\subsection{Computing the rent share}\label{SS:rentshare}

\subsection{Computing the target interest rate}\label{

 The target interest rate, $r_{target}$, is the prime rate plus a margin required by the bank.  Question: do non-bank actors have such a term?
