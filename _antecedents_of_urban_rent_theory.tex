...
The physiocratic school of economics was the first to see labor as the sole source of value but, % who were the physiocrates?
% Why does it matter that it was the sole source of value. Who else thought that. How does this connect with our argument?
for the physiocrats, in the context of the prevalent European rural society of the time, only agricultural labor created a surplus. % actually? This was the theory?
%The canonical reference for only agricultural labour mattering? For the definition of rent?
% Is Ricardo a phisiocrat? Does he argue with them? Describe them? Which period is each in?
...
The third determines the extent of the city. A simple case is the circular city with uniform transportation cost, $t$. \[r^*= \frac{w}{t}\]% A more complex model might have density depend on location, for example, in the continous circular cityt\,
