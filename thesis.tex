...
\usepackage{enumitem}
\usepackage{lmodern} % sizing text in tikz


%%  PERFECTLY BUT NEED TO ADD BACK IN CAPTION
\usepackage{graphicx}
\usepackage{afterpage} % For handling page styling
\usepackage{caption}

% % CENTERED BOTTOM PAGE NUMBER, NO HEADER, NUMBERS REMOVED BEFORE
...
% \fancyfoot[C]{\thepage} % Default page number at the bottom center
...
\appendix
% Add an un-numbered title page before the appendices and a line in the Table of Contents\input{glossaries}
\chapter*{APPENDICES}
\addcontentsline{toc}{chapter}{APPENDICES}
% Appendices are just more chapters, with different labeling (letters instead of numbers).
\input{_appendix-list.tex}
