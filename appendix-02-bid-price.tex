...
The selling process can be summarized as

\begin{enumerate}
    \item Identify set of sellers for the current cycle:
    \begin{enumerate}
        \item people retiring in this cycle,
        \item people who retired and failed to sell,
        \item we can add, people approaching retirement who might consider selling early.
        \item the bank
    \end{enumerate}
