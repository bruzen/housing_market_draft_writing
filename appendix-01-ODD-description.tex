...
\end{tikzpicture}
\caption[The platform, the process, and the outcomes]{The major processes: production sector which forms the platform creating value distributed though rents, the housing market which is the process actors claim social value, and the social outcomes that may emerge. %. Feedback loops are omitted. %{\color{red} CAN WE ELABORATE? The platform, the process, and the outcomes}.
}
\label{fig:outcomes}
\end{figure}
