...
Rural and urban owner-occupiers and tenants belong to the agent class, Person. Newcomers are persons seeking to purchase or rent land, to join the urban workforce in a period. They become owners or tenants. Urban owner-occupiers and tenants make up the primary workforce. %(The city has a small and fixed core population.) 
...
Newcomers enter the model to replace retirees. They bid on properties. % Tenants do not bid but may be replaced by newcomers who do bid. 
If newcomers make a successful bid they become owner-occupiers. If no newcomer purchases a property, the non-resident owner will rent it to newcomer tenants.  % they become tenants. 
If investors outbid tenants and newcomers, they become non-resident owners.  For simplicity, we present the model for the case where individuals have the same preferences, employment opportunities and transportation costs.
