...
\epigraph{If we postulate only the usual list of economic forces, cities should fly apart. The theory of production contains nothing to hold a city together. A city is simply a collection of factors of production---capital, people, and land---and land is always far cheaper outside cities than inside. Why don't capital and people move outside, combining themselves with cheaper land and thereby increasing profits?}{}
...
In The Economy of Cities (1969) % , Jane Jacobs \dots \cite{jacobsEconomyCities1969}

Jacob's analysis answers an important question in economics. 
...
The value in cities is not static, it actually grows over time.  In this chapter, we'll link the basic spatial model to the scaling of urban productivity, providing the foundation for our model of urban agglomeration effects.

\section{Cities and the scaling literature}
The scaling literature has confirmed this basic result about the value of urban density:
...
The question now is whether we can find estimates of t. This is what the empircal work on scaling laws profides.
