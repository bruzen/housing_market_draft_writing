...
\chapter{Distribution and Growth}
...
Our interest in this thesis is on how financialization might affect cities, and in this chpaper specifically on the channels through which financializaiton might affect the productivity and growth of cities.

 Lobo et show that Equation~\ref{equation-the-fact} can be written   as an explicit function of population size, $N_i$, and specific local deviations, $\xi_i$ that they  call a Scale-Adjusted Metropolitan Indicator (SAMI). The SAMI htey deerive depends on local wages and capital costs. The  SAMI accounts for the residuals when $\beta$ is estimated. Their preferred form is
...
(We immediatly suspect that financialization make less clocal capital avaialble and raises the cost of capital in the city.  Is this correct?)

(We also wonder i f we need to incorporate effective labour, which raises $L_0$. Cutting trtransportation costsx will cut the neccessary wage and increase the effective wage and proiductivity)
