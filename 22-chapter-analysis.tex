...
\section{Class}
We use the concept of class  to explore the consequences  of financialization in the housing market. The term class was  used  by classical economists to refer to patterns in the ownership of productive assets. Those who had only their labour to sell were ``working class''. Those who lived of the rents from the land they owned were ``landowners''. Those who captured the surplus from industrial production because they owned the capital stock were capitalists, and those who lived off the interest of money lent were ``rentiers''. 
...
\section{financialization amplifies the problem housing shortages }
