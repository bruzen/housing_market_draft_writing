...
In Ontario, 70\% of new condo units are owned by investors not residents \cite{pickelInvestorsOwn772023} and asking rent in Canada increased by 10\% in February 2024 \cite{AskingRentsCanada2024}. 
...
% \begin{enumerate}
    ...
    % \item Chapter~\ref{chapter-conclusions} concludes.
\end{enumerate}
