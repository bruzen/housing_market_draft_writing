...
In Ontario, 70\% of new condo units are owned by investors not residents \cite{GET77percent}. % (a change from .. ). 
...
% \cite{
tomaskovic-deveyFinancializationCausesInequality2013, palleyFinancializationWhatIt2007, seccarecciaUnderstandingFinancializationHistory2013, nemtinFinancializationHousingSocial2021}.  
...
Financialization is one of two major transformations changing society. The other is urbanization. % two historic processes are changing society, powerful. 
% Two historic 
...
In this thesis, we are concerned with how these processes are beginning to interact in the urban system. To explore this, we have built a model of an urban system, to explore financialization in the context of housing markets. Specifically we explore the systemic effects of the shifting ownership of property in cities on the distribution of wealth and % the capacity of cities to grow  %. We explore the effects of financialization on the distribution of wealth, as well 
the potential that this shift can actually change the ability of cities to 
grow, thrive, and produce wealth.
...
% The link between the two processes is that 
when people concentrate in cities, it increases productivity across a range of measures of output including GDP and GNP. There's never been a rapidly developed urban city without growing productivity. The effects of urbanization are so profound that cities now produce most of the wealth of society. 
...
The city generates a surplus, and finacialization is about capturing surplus. 
...
Financialization is not neutral. It is increasingly associated with %understood as a contributor  to
...
People come to cities because of their productivity, but that means that they need places to live and they compete for those places, so land around the city and close to the city becomes valuable. That means that whoever owns the land can charge for its use and capture what are called \glspl{locational rent}.  
...
% What new models have done is 
% TO DO THIS, WE NEED A MODERN THEORY OF URBAN RENTS Narrative accounts of financialization, describing what's happening, but we try to model it, there's a gap. % IT IS A CHALLENGE TO EXPLAIN THESE EFFECTS WITH CURRENT THEORY. don't actually have a theory for who gets the urban rents. 
% gap between urban/and economic. 
% WHAT WOULD BE THE GAP IN MAKING A THEORY OF WHO GETS THE RENTS
% STORIES OF DISTRIBUTION HAVE BEEN A BIG PART OF ECONOMIC HISTORY..
% TO CREATE ONE, WE DRAW ON THE classical theory of who gets the product of land and how that affects the social classes.
...
% \section{Cities, locational value, and financialization}
...
To analyze the distribution of the value created in the city, we employ the idea of spatial rent, and put it into a model that allows for financialization of urban housing market.

This work therefore draws together insights from urban economics, geography, and planning. 
A central, shared concern in all three fields is geographic space: in all three locational value gives rise to land rents, which explains the dynamics of economic development, and the spatial distribution of human activities.%, and  financialization, and continuing productivity.  %DOES ANY OF THIS BELONG WITH LOCATIONAL RENT ABOVE?
Modern urban theory  % Urban models have 
 describes where land rents appear  in space. 
Neoclassical economic theory explains how the rest of the value of production is shared. % labour and capital. 
%, but does not explore who gets those rents. %There isn't, however, a theory of who gets the rents that are produced by the city.
What's missing is an account of who gets the land rents in the urban system. To model this, we need to go back to the version of rent theory developed by the classical economists.%, rent- but integrate it in a.
This is a significant step because, while Classical rent is foundational to all Urban rent theory, the distributional aspects of the theory have not been applied. 
...
Production is a process of using real inputs to produce a real output, fin the process to claim rights to surplus.
...
% CHECK THAT WE INTRODUCE AGGLOMERATION EARLIER - MAYBE IN THE SPATIAL VALUE OF CITIES SECTION?
...
Figure~\ref{fig-financial-cycle} illustrates the second component of our model, the financialization process. We develop an explicit model of investor behaviour to explain the market decisions of buyers and the role of financial capital. The key observation is that investors enter the housing market. In doing so they drive up prices by increasing total demand. The rising price generates an expectation of capital gains, which enter the investors' calculations. Investors have, as research shows, better access to capital than most new entrants to the housing market. When the financial sector, the bank in the model, makes more capital available, the pattern of ownership shifts, as illustrated above. % The theory of financialization is discussed in detail in Chapter ~\ref{chapter-financialization}.
