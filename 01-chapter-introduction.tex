...
This work %approach 
draws together insights from geography, planning and urban economics. The central and shared concern all three %in these 
fields is geographic space. ELABORATE% The organizing principle in the spatial models of all three disciplines is an economic variable, land rent, 
...
\node at (Solow) [below=2.1cm, align=left] {Neoclassical Growth Theory};
...
%\node [circle, shading=ball, minimum width=2.4cm, white, align=center] (ball) at (finance)[text width=2cm] {Finance};
\draw [line width=2mm, red!85, -latex ] (-.1, 7.1)--++(0,1.2)node[above=-.1] {\Large \textbf{FINANCE}};
...
The first effect of financialization on housing allocation, arises because the rents generated by the agglomeration economies in the urban system are diverted to largely non-resident owners, away from investment in local production or amenities. 
...
The second effect of financialization on the market is in the allocation of rents. This effect arises because with growing financialization, tenants replace owner-occupiers. % are gradually replaced by tenants. 
While owner-occupiers share in the growing land rents generated by urban agglomeration effects, tenants do not. As a result, a declining fraction of urban residents accumulate capital through their participation in the housing market, and therefore fewer enter the class of workers with both wage and capital income. 
...
Figure \ref{fig-Alonzo-Jacobs-cycle} illustrates the third component, the model of productvity incorporating agglomeration effects. %the productivity of cities, incorporates the productivity of cities.  
...
\gls{Alonzo-Jacobs model} /cycle because EXPLAIN FEEDBACK LOOP
...
\begin{enumerate}
    \item Financialization of the housing market will result in the decline of the urban middle class ELABORATE and
    \item Financialization of the housing market will result in reduced growth of urban productivity. DUE TO THE FEEDBACK LOOP OF 
\end{enumerate} 
