...
The city is productive, it generates a surplus, and finacialization is about capturing surplus.
...
Owning land is a claim on some of those rents. 
...
Neoclassical theory explains who gets the products of production. % labour and capital. 
There is also a spatial urban theory that has % Urban models have 
produced a way of describing where those rents are, but they don't explore who gets those rents of where the land rents in cities are located. There isn't, however, a theory of who gets the rents that are produced by the city.

To model who gets the rents, we need to go back to an idea well developed by the classical economists, rent- but integrate it in a -..
