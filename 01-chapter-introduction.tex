...
\section{Modelling financialization of an urban housing market}
...
We then incorporate that result into the standard urban model, building of the work of %associated with 
William Alonzo and others \cite{alonzoTheoryUrbanLand1960}.   
We call the combined sub-model the \gls{Alonzo-Jacobs model}.
