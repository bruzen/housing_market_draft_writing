...
\end{tikzpicture}
    ...
    \caption{Space and urban rents play a foundational role in urban economics, geography, and planning, we extend the the analysis of urban rents to model the effects of financialization.} %***TODO FLIP ECON AND PLANNING TO FOLLOW ORDER OF CHAPTERS}
    \label{fig-fields}
\end{figure}

\section{Position in the literature}
% This work draws together insights from geography, planning, and urban economics. The central and shared concern all three fields is geographic space.
This work draws together insights from urban economics, geography, and planning. The central and shared concern all three fields is geographic space. Locational value explains the dynamics of economic development, the spatial distribution of human activities, and urban form.  % ELABORATE% The organizing principle in the spatial models of all three disciplines is an economic variable, land rent, 
...
Figure~\ref{fig-fields} illustrated both the synthetic aspect of our analysis and the direction in which we develop existing  work. Some of the most relevant contributors in each field are listed. % The literature in each field is far too large and diverse for our figure to do it justice. 
% In economics, theories of growth, agglomeration, in geography Alonzo's basic urban model and the spatial urban rent profile \cite{alonsoLocationLandUse1964}, and planning, j work on location theory and the or urban activities.

Classical economist David Ricardo  elaborated the theory of land rents in 1815. Johann von Th/"unen 1783 -- 1850) produced the first serious treatment of spatial economics and economic geography, apparently independently in 1826. In 1961 Alonzo (and others) applied the  Ricardian and von Th/"unen theory to the urban system, launching modern urban theory. Meanwhile in economics, Solow set off a flood of work on  economic growth growth that  spilled into urban theory through through Jacobs, Lucas and Bettencourt. 
...
rigorously/precisely simulates the relevant system features and can incorporate a wide range of intervention types. %way the simulation model is coded. 
\end{enumerate}
