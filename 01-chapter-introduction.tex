...
This work draws together insights from geography, planning, and urban economics. The central and shared concern all three fields is geographic space. Locational value explains the spatial distribution of human activities, urban form,  and the dynamics of economic development.  % ELABORATE% The organizing principle in the spatial models of all three disciplines is an economic variable, land rent, 
...
Figure~\ref{fig-fields} illustrated both the synthetic aspect of our analysis and the direction in which we develop existing  work. We begin in the region of overlap among the three disciplines with the fundamental linking construct, space. Some of the most relevant contributors in each field are listed. % The literature in each field is far too large and diverse for our figure to do it justice. 

Cklassical economist DaviuDavid rRicardo 
...
% NAME THEM ALL AND CITE HERE?
% Solow
% Lucas
% Jacobs
% Bettencourt
% von Thunen \cite{}
% Alonzo work on the basic urban model and the urban rent profile \cite{alonsoLocationLandUse1964}.
...
The green boxes in the figure represent theoretically justified simplifications we employ 
