...
Figure~\ref{fig:Financialization-expansion} illustrates financialization  as a flow of money into the housing market, expanding financial ownership and tenancy while reducing the share of owner-occupied housing. Its goal is the capture of spatial rents, which we will show has implications for both the productivity and the class structure of the city. Financialization of the housing stock does not add  tot he housing stock. It is a process of transferring ownership of existing housing units.  In the urban context financialization is fundamentally rent seeking. This thesis focuses on the potential macro effects of financial capital capturing urban spatial rents. 
...
\section{Financialization and Housing Supply}