...
****** ADD---EXPLAIN WHAT A housing market financialization process, and a production system IS
...
The second effect of financialization on the market is in the allocation of rents. Rents generated by the \gls{agglomeration} economies in the urban system are diverted to largely non-resident owners, away from investment in local production or amenities, as tenants replace owner-occupiers. % are gradually replaced by tenants. 
