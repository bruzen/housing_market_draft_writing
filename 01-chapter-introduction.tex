...
People come to cities because of their productivity, which means they need places to live and they compete for those places, so land close to the city ***E ADD CENTRE?  becomes valuable. That means that whoever owns the land can charge for its use and capture what are called \glspl{locational rent}. ***E ADD IN ESSENCE, THIS MEANS  THAT?? Owning land is a claim on the productivity of the city. *E i FEEL IT WOULD BE USEFULL TO RESTATE THIS. IT SEEMS LIKE AN IMPORTANT CLAIM AND THIS IS A CLEAR AND DIRECT SRTICULATION BUT UNPACKING IT IN FOLLOW-UP SENTENCE MIGHT MAKE IT EASIER TO KNOW WHAT IT MEANS. eG: In other words... or that is to say....
...
\begin{enumerate}
    ...
    \item Chapter~\ref{chapter-rent} reviews the literature on rent and develops an approach ***E  i FIND THIS PHRASING A A BIT AMBIGUOUS. ARE YOU DESCRIBING HOW YOU DEVELOPED THE APPROACH OR LAYING OUT THE APPROACH??? suited to the analysis for this work.
