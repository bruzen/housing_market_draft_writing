...
has contributed to the wide distribution of wealth, particularly in North America \cite{pikettyCapitalTwentyfirstCentury2014}. % It is a key differentiator between who has built wealth and who hasn't. % ADD FACTS. %This is seen in the racial wealth gap, the immigrant wealth gap, and the youth wealth gap. 
...
***E MORE DETAIL ABOUT THIS %Through changing legal structures, development of financial tools, and ... and increase of property speculators. The result is that the ownership is shifting/ For example, in Waterloo 77% of new property is own by investors not residents (Change from dATE) . For the first time in Canadian history the rate of home ownership has declined. This is a general shift away from --- to ----
...
Because of the significance of property to wealth distribution, the shift to financialized ownership % this shift %/this financiazation
has a big effect on distribution \cite{tomaskovic-deveyFinancializationCausesInequality2013, palleyFinancializationWhatIt2007, seccarecciaUnderstandingFinancializationHistory2013, nemtinFinancializationHousingSocial2021}. %This is accept SEEN IN XY say.  % \cite{nemtinFinancializationHousingSocial2021}, \cite{}
***E There is an emerging understanding that financialization affects accessibility and affordability of housing. Financialization has been talked about in this way. People working in housing have noted the people can be priced out of the city as speculative approaches to housing lead to attempts to claim more rent. Fewer people are able to buy houses and those renting face higher rents and decreased ability to build wealth. This idea has been introduced as possible contributor to the current housing crisis. What has not explored as much is the systemic effects of financialization. 
...
This work draws together insights from urban economics, geography, and planning. The central **E %CUT AND??
and shared concern all three fields is geographic space. Locational value explains the dynamics of economic development, the spatial distribution of human activities, and urban form.  
