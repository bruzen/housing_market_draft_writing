...
There are two big transformations society is undergoing. One is continued urbanization, and the other is the process of financialization. %, which is just a feature of the capitalist system/expansion of capital. 
They are beginning to interact in the urban system. 
The reason is the city is productive, and financialization is all about capturing/owning the flow of products from any process.

cities create value.

% exists land rent, and who gets the rents
There exist a neoclassical theory of production that explain who gets the products of labour and capital. Thre is also a theory of where the land rents in cities are located, but there isn't a theory of whose getting the rents that is actually a part of the productivity of the city. This can come from the older theory of rents.
...
but there's a gap the formal apparatus in standard economic theory for analyzing the distribution of the enormous value created. It connect connect to neoclassical.
...
the empirical evidence is that cities produce now, most of the wealth of society.
There's never been a rapidly developed urban city without growing productivity. That is well established empirically. 


% claim productivity,  - right to be productive in the city.. claiming the rents -the value in cities.. claim iwith financial instruments... once you have that in one model, you can actually do that link..  people think there is a return on investment,  what is it they're getting, it's a return on investment. 
