...
\begin{enumerate}
    ...
    \item Chapters~\ref{chapter-ownership}, \ref{chapter-productivity-spillovers}, and \ref{chapter-amenity} analyze the results of a series of experiments with the model, exploring both the static and dynamic resilience effects of interventions. % including our conclusions about the resilience of our social structure in the face of financialization.
