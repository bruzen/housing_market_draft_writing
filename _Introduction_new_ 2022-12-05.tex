...
} Together these areas represent the ``produce of the earth'' that Ricardo is analysing, but only the rent, represented by lower triangle, is  net economic product.\footnote{ Termed the `\textit{produit net}' by the Physiocrats} In modern supply and demand analysis it would be recognized as `producer surplus'.
