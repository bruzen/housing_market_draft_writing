...
\draw [<->] (0,6) node[left, text width=1cm]{Buyer pays}-- (0,0)node[left]{0}node[below]{0} -- (6,0) node[below right, text width=1cm]{Seller gets};
\draw [red, thick, latex-latex ](1.5,5.5)node[below, black]{Feasible set}-- (2,6)--(5.5,2.5)--(5,2);
...
\draw [ latex-latex, ultra thick](3.7,7)-- (3,7)--(3,3)--(8,3)--(8,3.7)node[above left]{Rational Set} ;
\draw [ latex-, thick, red](3.5,4.5)-- (4,5)--(5.5,5)node[right]{Bargaining Set} ;

\draw [ latex-, thick, red](2.5,5.5)-- (3.6,6.5)--(5.5,6.5)node[right]{Efficient Set} ;
