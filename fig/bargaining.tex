...
\node [above](Seller)at (-1,7) {Seller};
...
\draw[ultra thick, blue!60,-latex](-1,6.2)--++(0,-1)--++(4,0)node[right, red]{Compare};  %Pass P_R to if-then
...
\draw[ultra thick, -latex](3,5)--++(0,-.5)--++(2.2,-.5)node[below, text width=1.cm, align=right]{One above {$P_R$} };
% down and Right
...
\draw[ultra thick, -latex](3,2.4)--++(0,-.75)node[below, text width=2cm, align=center]{No sale};

\draw[ultra thick, -latex](5.5,2.4)--++(0,-.75)node[below, text width=2cm, align=center]{Bargain: price is power-modified mean};
\end{scope}
