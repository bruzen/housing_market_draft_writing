...
%  TEXT
\node at (13.8,12.5) [left, text width=4.5cm]{ cities exhibit increasing\\ returns to population\\ $\beta>1$};%IRS
\node at (13.5,6.5)[text width=4.5cm, align=right] {cities might\\ exhibit decreasing \\returns to population \\ $\beta<1$};% DRS

% ARROW
\draw[latex-latex, ultra thick] (13, 11.22)--(13, 9.6);
\node at (15.2, 10.9)[ text width=2.5cm, align=right]{\textbf{agglomeration\\ surplus}};
