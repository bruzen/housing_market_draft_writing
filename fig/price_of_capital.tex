...
\draw [thick] (0,\Y)node[above=.25cm]{lending rate} -- (0,0)--(\W,0)node[below]{Wealth}node[below=.5cm] {in hundred thousands};   	% Axes

\draw [thin] (0,\rbar) node[left=.5cm]{$\bar r$} -- (\W, \rbar);  	% % bank rate line
