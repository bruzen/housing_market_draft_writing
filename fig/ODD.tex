...
\draw [arrow] (agglom-adjust.west) -- ++(-1.5,.5)  |- (firmupdate)node[midway,above right] {adjust population N}; 

\draw [arrow, red] (agglom-adjust.west) -- ++(-2.5,-.75)  |- (mainloop)node[midway,above right] {adjust productivity A}; 
%-- ++(0,-.5) -- ++(7,0) |-
%-- ++(0,-.5) -- ++(7,0) |-
% % % Custom arrow path
