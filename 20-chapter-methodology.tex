...
By including individuals explicitly, agent based models offer particular nuance in exploring the effects of individuals on a system. The structures that emerge result from assumptions about the decisions of those in the system rather from assumptions about the behaviour of the system. Agent based models may reveal non-obvious implications of structural changes \cite{darley_towards_1999, happe_agricultural_2004}. 
...
They thus make it possible to look at the structural impact of policy on particular types of individuals, and to provide a more accurate picture of the whole systems policy makers would be working in.
