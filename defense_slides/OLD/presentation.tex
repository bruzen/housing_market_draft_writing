...
% Change typesetting engine to "xelatex" or "lualatex" vs   "latex" or "pdflatex
...
\input{defense_slides/OLD/slides/fig}
\input{defense_slides/OLD/slides/fig2}

% \input{slide_deck/slides/fig}
% \input{slide_deck/slides/fig2}
% \input{slides/examples/bullets}
% \input{slides/examples/splitfigs}
% \input{slides/examples/equations_annotated}
