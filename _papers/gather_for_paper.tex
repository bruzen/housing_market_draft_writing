...
\section{We want a paper that is called something like:}
...
In the context of a widely-felt housing crisis, we explore how the capture of urban value by financial actors through the financialization of the housing market\footnote{In the absence of profitable investments in the productive sphere due to the overaccumulation crisis triggered in the late 1970s, capital began moving toward financial speculation, creating strong distortions in the sphere of social surplus value distribution through the financialization of the capitalist class, which has led to an explosion of fictitious capitalfinancial assets without a counterpart in material production. CITE(Robert Brenner, The Boom and the Bubble: The U.S. in the World Economy (New York: Verso, 2002); John Bellamy Foster and Hannah Holleman, "The Financialization of the Capitalist Class: Monopoly-Finance Capital and the New Contradictory Relations of Ruling Class Power," in Imperialism, Crisis and Class Struggle: The Enduring Verities and Contemporary Face of Capitalism, ed. Henry Veltmeyer (Leiden: Brill, 2010).)} 
affects ownership patterns in urban areas, and the ultimate implications of these processes for urban productivity.\footnote{We relate this to Marian notions of natural capital and `earth capital'≥ the following is from Nature as a Mode of Accumulation: Capitalism and the Financialization of the Earth \cite{fosterNatureModeAccumulation2022} 
by John Bellamy Foster.
\begin{quotation}Marx, as he later recounted in volume three of Capital, introduced “the distinction between terre-mati\'ere and terre-capital,” or between earth matter and earth capital:
\begin{quotation}
Land, so long as it is not exploited as a means of production, is not capital. Land as capital [terre-capital] can be increased just as much as all the other instruments of production. Nothing is added to its matter, to use M. Proudhon’s language, but the lands which serve as the instruments of production are multiplied. The very fact of applying further outlays of capital to land already transformed into means of production increases land as capital without adding anything to land as matter [terre-mati\'ere], that is, to the extent of the land. M. Proudhon’s land as matter is the earth in its limitation. As for the eternity he attributes to land, we grant readily it has this virtue as matter. Land as capital is no more eternal than any other capital.%22 
\end{quotation}
In this passage, Marx draws a distinction between land, viewed on the
one hand as eternal earth matter (terre-mati\'ere, or mere matter), and, on the other, as historically generated earth capital (terre-capital).  \end{quotation}

There is an interesting question: Marx wrote (Marx, Capital, vol. 3, 756.), ``value is labour, so surplus-value cannot be earth.'' In cities, the earth, as we show, provides access to the value of labour in the fraction of wages paid as differential rent.}
