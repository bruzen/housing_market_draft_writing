...
% It occurs when %we have a process underway in which 
% accumulated wealth/AWK capital goes looking for streams of revenue 

%CUT AWKand one way to get to invest is to buy land and capture the future stream of agglomeration economies the wealth created by the city being bringing people together.
...
% What we do here.. - introducing this piece in a formal model - This is what we and others argue is the dominant mentachinsm,  
We argue that this mechanism of claiming surplus through rents, is at the heart of % the financialization of housing, % what we argue is the main mechanism driving what's happening specifically in financializatin in urban centers. 
