...
\begin{itemize}\Large
    \item Urban theorists in the 196'0 developed a model that is isomorphic with respect to travel costs and distance
...
\node at (9.5,0)[below left, text width=2cm, black, align=right, red]{ edge of city};
\node at (-.25,0) [below right, red, align=left]{Jobs at city center};
\node at (.25, 3.5)[right, red]{Urban wage premium};
...
\begin{frame}{}
  \centering \Large
  \emph{The Mode Main Loop}
  
    \emph{Three main blocks}
...
\item with no CGT investors eventually take over the entire housing stock. 
