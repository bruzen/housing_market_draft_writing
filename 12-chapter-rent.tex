...
In colloquial contexts, class is often used informally as if it refers straightforwardly to people who have different levels of wealth, but when economists talk about classes, they mean something slightly different. Economics classes are traditionally divided up by how they participate in production. So labour, or owners of labour, participate by supplying their labour to the production for with they are paid. Landowners own the land... And owners of Capital provide... Ricardo began theorize how surplus is distributed amongst these classes. It's because the surplus is differently distributed that that different have different wealth levels. 

 This is what Ricardo developed the concept of rent to explain.  Class structure, or how different classes participate in production changes over time as modes of production change. When Ricardo was writing, the economy was still largely structured around feudalism. (IE DESCRIBE role of labour land, capital under feudalism and how this was changing in that period.) After/ During the industrial revolution this changed... Class theory developed with thinkers like Marx to account for this. By the time the marginalist began to give theer account of distribution their economies were largely.... LIKE WHAT. Now.... summarize key shifts. 
 
 These change are part of what this thesis is designed to account for. The concept of rent is specifically relate to surplus and enabled Ricardo to first talk about how s is key to distribution within the economy, amongst classes.  Ricardo essentially developed his concept of Rent to explain the dynamics of distribution between classes. 
...
The concept of rent in economics must be distinguished from the current common use of the term to mean the payment paid to rent a property. 
...
Ricardo's analysis of land  can be thought of as focussinbg onlky on land:

\begin{equation} 
Y=F(L,N).
\label{Eqn:2agricultural}
\end{equation} 
