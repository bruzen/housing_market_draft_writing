\chapter{Removed from model chapter}
 In addition, wealth inequality (including housing) has been rising, which according to Piketty results from the return to capital being higher for wealthier persons and remaining high relative to the growth of earnings despite the growth in the capital-output ratio.
